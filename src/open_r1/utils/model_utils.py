...
def get_tokenizer(
    ...
    print (f"model_args.model_revision: {model_args.model_revision}")
    print (f"model_args.trust_remote_code: {model_args.trust_remote_code}")
    print (f"training_args.chat_template: {training_args.chat_template}")
    print (f"auto_set_chat_template: {auto_set_chat_template}")
